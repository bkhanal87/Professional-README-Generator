...
text = addTableOfContents(text, userDescription, installation, usage, license, contributing, tests, questionContent);
...
function addTableOfContents(text, userDescription, installation, usage, license, contributing, tests, questionContent){
      let toc = "";
